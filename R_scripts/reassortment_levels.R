...
set.seed(1)
pops <- round(rnorm(100, mean = 5, sd = 1))
...
list.other <- function(rep.list){
  other.flat <- list()
  for(i in seq_along(rep.list)){
    other.flat[[i]] <- rep.list[-i]
